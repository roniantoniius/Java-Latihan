...
public class AwareTest {
    ...
    @BeforeEach
    void setUp(){
        applicationContext = new AnnotationConfigApplicationContext(BeanPostProcessorTest.TestConfiguration.class);
    ...
    void testAware(){
        ...
        Assertions.assertEquals("roniantonius.spring.core.service.AuthService", authService.getBeanName());
